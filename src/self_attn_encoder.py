...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, src_tokens):
        ...
        x1 = self.embed_scale * self.word_emb(src_tokens[:, :2])
        x2 = self.embed_scale * self.sememe_emb(src_tokens[:, 2:])
